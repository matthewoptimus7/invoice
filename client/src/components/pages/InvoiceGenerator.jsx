...
const InvoiceGenerator = () => {
    ...
    useEffect(() => {
        ...
        const getSenderData = async () => {
            // /get/SenderDataInvoiceAddress
            const getSenderDataRequest = await axios.post(`${API_URL}invoice/invoice_get/SenderDataInvoiceAddress`, 
                { senderid: senderid },{
                    headers:{
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // get/getUserList
                const dropDownUserResponse = await axios.post(`${API_URL}invoice/invoice_get/getUserList`, 
                    { inputValues },{
                        headers:{
                            Authorization: `Bearer ${jwt_token}`
                        }
                ...
                console.log("dropdown user response");
                console.log(users);
                ...
                // get/productList
                const dropDownResponse = await axios.post(`${API_URL}invoice/invoice_get/productList`, 
                    { inputValues },{
                        headers:{
                            Authorization: `Bearer ${jwt_token}`
                        }
    ...
    const getuserDetial = (customerName, value) => {
        ...
        const getReciverData = async () => {
            // get/ReciverDataInvoiceAddress
            const getReciverDataRequest = await axios.post(`${API_URL}invoice/get_invoice/ReciverDataInvoiceAddress`, 
                { reciverid: value },{
                    headers:{
                        Authorization: `Bearer ${jwt_token}`
                    }
    ...
    useEffect(() => {
        const getSign = async () => {
            ...
            try {
                // get/getSignExistance
                const SignRes = await axios.post(`${API_URL}invoice/get_invoice/getSignExistance`, 
                    { currentUser: currentUserVar },{
                        headers:{
                            Authorization: `Bearer ${jwt_token}`
                        }
                    });
                console.log("singature ajax result");
