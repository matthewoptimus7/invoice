...
const Login = (props) => {
    ...
    const validate_login = async () => {
        ...
        async function checkCredentials() {
            try {
                // 
                const response = await axios.post(`${API_URL}user/verify/credentials`,
                    {
                        username: username,
                        password: password,
                    }
                ...
                if (response.data.success) {
                    ...
                    if (response.data.password === null) {
                        setLoading(true);
                        // send-email/updatePassword
                        const setPasswordMail = await axios.post(`${API_URL}user/send-email/updatePassword`, { username });
...
<span style={{ fontFamily: "'Raleway', sans-serif", fontSize: "16px" }}>
