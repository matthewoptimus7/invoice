...
const Order_Management = (positionid) =>{
    ...
    const getOrderData =() =>{
        ...
        // getOrderData
        axios.post(`${API_URL}order/order_module/getOrderData`, {userid:userid_getdata},{
            headers:{
    ...
    const select_order = async(order_id)=>{
        ...
        setchild_data([]);
        // get_order_item
        const output_res = await axios.post(`${API_URL}order/order_module/get_order_item`,
            {order_id:order_id},{
                headers:{
                    Authorization: `Bearer ${jwt_token}`
                }  
    ...
    const submitOrder = async() =>{
        ...
        if ((payment_mode_selection==='online_payment')&&(selected_id.transaction_id==='' || selected_id.transaction_id===null)) {
            ...
            // Order_submition
            const output_res = await axios.post(`${API_URL}order/distributor_order/Order_submition`,
                {order_data:selected_id,order_item:child_order_data,payment_status:payment_mode_selection},{
                    headers:{
                        Authorization: `Bearer ${jwt_token}`
                    }   
                });
